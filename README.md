...
A token is used to verify that the HTTP request is authorized. Without the token the backend server will reject the request and return a 401 error code.
